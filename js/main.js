...
$(window).scroll(function () {
    ...
    handleScrollAnimation('#fadeRight', 'animate__fadeInRight', 'animate__fadeOutRight', 0.5);
});

// CODE FOR SECTION ABOUT ME
$(window).scroll(function () {
    handleScrollAnimation('#backLeft', 'animate__backInLeft', 'animate__backOutLeft', 0.5);
    handleScrollAnimation('#backRight', 'animate__backInRight', 'animate__backOutRight', 0.5);
});

// CODE FOR SECTION PORTFOLIO
$(window).scroll(function () {
    handleScrollAnimation('#fadeInTopLeft', 'animate__fadeInTopLeft', 'animate__fadeOutTopLeft', 0.5);
    handleScrollAnimation('#fadeInTopRight', 'animate__fadeInTopRight', 'animate__fadeOutTopRight', 0.5);
});

// CODE FOR SECTION CONTACT
$(window).scroll(function () {
    handleScrollAnimation('#bounceIn', 'animate__bounceIn', 'animate__bounceOut', 0.5);
    handleScrollAnimation('#bounceIn2', 'animate__bounceIn', 'animate__bounceOut', 0.5);
});
